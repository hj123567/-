<template>
  ...
  >
    ...
    <el-sub-menu v-if="this.judgeIdentity()===1" index="2-1">
      <template #title>
        <el-icon>
          <user-filled/>
        </el-icon>
      ...
      <el-menu-item index="/dormAssign">新生宿舍分配</el-menu-item>
    </el-sub-menu>
    <el-sub-menu v-if="this.judgeIdentity()!==0" index="3">
      ...
      <el-menu-item v-if="this.judgeIdentity()===2" index="/buildingInfo">楼宇信息</el-menu-item>
      <el-menu-item v-if="this.judgeIdentity()===1" index="/buildingInfo">楼宇信息</el-menu-item>
      <el-menu-item v-if="this.judgeIdentity()===1" index="/roomInfo">房间信息</el-menu-item>
      <el-menu-item v-if="this.judgeIdentity()===2" index="/roomInfo">房间信息</el-menu-item>
      <el-menu-item v-if="this.judgeIdentity()===1" index="/dormScoreManage">卫生评分</el-menu-item>
    </el-sub-menu>
    <el-sub-menu v-if="this.judgeIdentity()!==0" index="4">
      ...
      <el-menu-item v-if="this.judgeIdentity()===1 || this.judgeIdentity()===2" index="/noticeInfo">公告信息</el-menu-item>
      <el-menu-item v-if="this.judgeIdentity()!==0" index="/repairInfo">报修信息</el-menu-item>
    </el-sub-menu>
    <el-sub-menu v-if="this.judgeIdentity()===2" index="5">
      <template #title>
        <el-icon>
          <coin/>
        </el-icon>
      ...
      <el-menu-item index="/utilityConfigManage">水电费配置</el-menu-item>
    </el-sub-menu>
    <el-sub-menu v-if="this.judgeIdentity()===1" index="5-1">
      <template #title>
        <el-icon>
          <coin/>
        </el-icon>
      ...
      <el-menu-item index="/utilityMeterReading">读数录入</el-menu-item>
      <el-menu-item index="/utilityBillManage">账单管理</el-menu-item>
    </el-sub-menu>
    <el-sub-menu v-if="this.judgeIdentity()!==0" index="6">
      ...
      <el-menu-item v-if="this.judgeIdentity()!==0" index="/adjustRoomInfo">调宿申请审批</el-menu-item>
    </el-sub-menu>
    <el-sub-menu v-if="this.judgeIdentity()===2" index="7">
      ...
      <el-menu-item index="/visitorInfo">访客信息</el-menu-item>
    </el-sub-menu>
    ...
    <el-menu-item v-if="this.judgeIdentity()===0" index="/myDormScore">
      <el-icon>
        <trophy/>
      </el-icon>
      <span>卫生评分</span>
    </el-menu-item>
    <el-menu-item v-if="this.judgeIdentity()===0" index="/myUtilityBill">
      <el-icon>
        <wallet/>
      </el-icon>
      <span>水电费</span>
