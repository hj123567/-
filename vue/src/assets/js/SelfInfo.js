...
export default {
    ...
    methods: {
        ...
        load() {
            ...
            if (!user) {
                console.error('sessionStorage 中没有用户信息');
                return;
            }
            ...
            this.dormRoomId = this.form.dormRoomId || "";
            this.avatar = this.form.avatar;
            console.log('load() - 用户信息加载完成:', this.username);
        },
        //查询数据，更新 session
        find() {
            this.form = JSON.parse(sessionStorage.getItem("user"));
            this.identity = JSON.parse(sessionStorage.getItem("identity"));
            console.log('find() - identity:', this.identity);
            console.log('find() - username:', this.form.username);
            // 只有当 identity 为'stu'时才调用登录接口
