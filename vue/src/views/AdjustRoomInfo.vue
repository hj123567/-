<template>
  <div>
    <el-breadcrumb separator-icon="ArrowRight" style="margin: 16px">
      ...
      <el-breadcrumb-item>调宿申请审批</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card style="margin: 15px; min-height: calc(100vh - 111px)">
      <div style="margin-bottom: 20px;">
        <h2 style="margin: 0; font-size: 20px; font-weight: 600; color: #303133;">调宿申请审批</h2>
        <div style="color: #909399; font-size: 14px; margin-top: 8px;">
          处理学生主动申请的调换宿舍，审核通过或驳回
        </div>
      </div>
      <div>
        <!--    功能区-->
        ...
        <el-table v-loading="loading" :data="tableData" border max-height="705" style="width: 100%">
          ...
          <!--      操作栏-->
          <el-table-column label="操作" width="190px" v-if="identity !== 'admin'">
            <template #default="scope">
          ...
          <el-table-column label="操作" width="100px" v-if="identity === 'admin'">
            <template #default="scope">
        ...
        <div>
          <!--      弹窗-->
          <el-dialog v-model="dialogVisible" title="处理调宿申请" width="50%" @close="cancel">
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form ref="form" :model="form" :rules="rules" label-width="120px">
                  <el-form-item label="学号" prop="username">
                    <el-input v-model="form.username" disabled style="width: 90%"></el-input>
                  </el-form-item>
                  <el-form-item label="姓名" prop="name">
                    <el-input v-model="form.name" disabled style="width: 90%"></el-input>
                  </el-form-item>
                  <el-form-item disabled label="当前房间号" prop="currentRoomId">
                    <el-input v-model="form.currentRoomId" disabled style="width: 90%"></el-input>
                  </el-form-item>
                  <el-form-item label="当前床位号" prop="currentBedId">
                    <el-input v-model="form.currentBedId" disabled style="width: 90%"></el-input>
                  </el-form-item>
                  <el-form-item label="目标房间号" prop="towardsRoomId" style="display: none;">
                    <el-input v-model="form.towardsRoomId" style="width: 90%"></el-input>
                  </el-form-item>
                  <el-form-item label="目标床位号" prop="towardsBedId" style="display: none;">
                    <el-input v-model="form.towardsBedId" style="width: 90%"></el-input>
                  </el-form-item>
                ...
                <el-card shadow="never">
                  <template #header>
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                      <span style="font-weight: bold;">可换宿舍</span>
                      <el-tag type="info" size="small">共 {{ emptyBeds.length }} 个</el-tag>
                    </div>
                  </template>
                  <div v-if="emptyBeds.length > 0" style="max-height: 400px; overflow-y: auto;">
                    <el-table :data="emptyBeds" stripe size="small" max-height="400" highlight-current-row>
                      <el-table-column label="房间号" prop="roomId" width="80" align="center"/>
                      <el-table-column label="床位号" prop="bedLabel" width="80" align="center"/>
                      <el-table-column label="操作" width="80" align="center">
                        <template #default="scope">
                          <el-button 
                            type="primary" 
                            size="small" 
                            @click="selectBed(scope.row)"
                          >
                            选择
                          </el-button>
                        </template>
