                ...
                <div style="width: 600px; margin-left: 30px; position: relative">
                    ...
                    <el-descriptions :column="1" :size="large" border style="min-width: 500px" title="">
                        ...
                        <el-descriptions-item v-if="identity === 'stu'">
                            ...
                            {{ dormBuildId }}号楼 {{ dormRoomId }}室
                        </el-descriptions-item>
                        <el-descriptions-item v-if="identity === 'dormManager'">
                            <template #label>
                                <div>
                                    <el-icon>
                                        <HomeFilled/>
            ...
            <div>
                ...
                <el-dialog v-model="dialogVisible" title="操作" width="30%" @close="cancel">
                    <el-form ref="form" :model="form" :rules="rules" label-width="120px">
                        ...
                        <el-form-item v-if="identity === 'stu'" label="学院" prop="college">
                            <el-input v-model="form.college" disabled style="width: 80%"></el-input>
                        </el-form-item>
                        <el-form-item v-if="identity === 'stu'" label="班级" prop="className">
                            <el-input v-model="form.className" disabled style="width: 80%"></el-input>
                        </el-form-item>
                        <el-form-item v-if="identity === 'stu'" label="宿舍楼" prop="dormBuildId">
                            <el-input v-model="form.dormBuildId" disabled style="width: 80%"></el-input>
                        </el-form-item>
                        <el-form-item v-if="identity === 'stu'" label="房间号" prop="dormRoomId">
                            <el-input v-model="form.dormRoomId" disabled style="width: 80%"></el-input>
                        </el-form-item>
                        <el-form-item v-if="identity === 'dormManager'" label="负责宿舍楼" prop="dormBuildId">
                            <el-input v-model="form.dormBuildId" disabled style="width: 80%"></el-input>
                        </el-form-item>
                    </el-form>
                    <template #footer>
