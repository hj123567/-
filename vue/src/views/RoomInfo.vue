      ...
      <div>
        ...
        <div style="margin: 10px 0">
          ...
          <div style="margin: 10px 0">
            ...
            <div style="float: right" v-if="identity === 'dormManager'">
        ...
        <el-table v-loading="loading" :data="tableData" border max-height="705" style="width: 100%">
          ...
          <!-- 床位展开-宿舍管理员-->
          <el-table-column type="expand" v-if="identity === 'dormManager'">
          ...
          <!-- 系统管理员只能查看，不能操作-->
          <el-table-column type="expand" v-if="identity === 'admin'">
            <template #default="props">
              <el-form inline label-position="left">
                <el-form-item label="一号床位" class="item">
                ...
                <el-form-item label="二号床位" class="item">
                  <el-tag v-if="props.row.secondBed != null" disable-transitions type="primary">{{ props.row.secondBed }}</el-tag>
                  <span v-else>空</span>
                </el-form-item>
                <el-form-item label="三号床位" class="item">
                  <el-tag v-if="props.row.thirdBed != null" disable-transitions type="primary">{{ props.row.thirdBed }}</el-tag>
                  <span v-else>空</span>
                </el-form-item>
                <el-form-item label="四号床位" class="item">
                  <el-tag v-if="props.row.fourthBed != null" disable-transitions type="primary">{{ props.row.fourthBed }}</el-tag>
                  <span v-else>空</span>
                </el-form-item>
              </el-form>
            </template>
          ...
          />
          <!--      操作栏-->
          <el-table-column label="操作" width="130px" v-if="identity === 'dormManager'">
            <template #default="scope">
